...
awesome, I'll see you then$$,
  ...
  $$[
    ...
    {"id":"current_situation","name":"Current situation","goal":"Use reversal to surface where they are now and open the gap.","playbook":"Reflect their dream back and ask about where they're at right now, so the gap becomes clear in their own mind (e.g. 'so you want to be lean at 90kg, where are you at weight-wise right now?'). Naturally get their age, rough location, and what they do for work (framed as gauging how active their days are) while you're here. Stay warm, never make them feel judged.","captures":["current_state","age","location","job","activity_level"],"advance_when":"You know their current starting point, plus rough age, location and job.","disqualify_when":"The lead is only after building muscle with no fat-loss goal at all."},

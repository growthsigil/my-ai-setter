...
QUALIFYING DETAILS (always gather):
...
- Everyone: before booking, make sure they're open to investing in themselves, without ever saying a number.
...
awesome, I'll see you then$$,
  ...
  $$[
    ...
    {"id":"pitch_call","name":"Pitch the call","goal":"Get a yes to a quick call, and confirm they can invest.","playbook":"ONE message: 'my schedule's pretty packed though, so it'd be easier to hop on a quick call in the next few days than go back and forth here, cool?' This is also where you gently make sure they're in a spot to invest in themselves if it turns out to be the right fit, without ever saying a number. If the lead is under 22 or based outside the USA and otherwise a good fit, go further and gently find out roughly how much they'd have available to invest in themselves before booking. Only advance on a clear yes.","captures":["financial_fit","investable_amount"],"advance_when":"The lead says yes to a call and hasn't ruled out investing.","disqualify_when":"The lead makes clear they cannot or will not invest any money in coaching at all."},
